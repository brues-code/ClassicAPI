-- Backport of Blizzard_APIDocumentation/BaseAPIMixin.lua to vanilla 1.12 /
-- Lua 5.0.
--
-- Implementation differences from the retail source: none. Every construct
-- here (method calls on string literals, string.format's %s, table.insert,
-- ipairs, CreateFromMixins) exists on this client.
