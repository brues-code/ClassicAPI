-- Backport of Blizzard_APIDocumentation/FunctionsAPIMixin.lua to vanilla 1.12
-- / Lua 5.0.
--
-- Implementation differences from the retail source: none.
--
-- A widget-method system (Type "ScriptObject") carries no Namespace, so
-- GetFullName prints its methods bare -- "SetSpellByID(spellID)" -- exactly as
-- retail prints its own widget API.
